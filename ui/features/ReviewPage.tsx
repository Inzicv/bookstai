    ...
    <div className="space-y-6">
      ...
      >
        ...
        <FormField label="user_opinion">
          <textarea className="min-h-32 w-full rounded-xl border border-zinc-200 px-3 py-2" value={form.user_opinion} onChange={(e) => setForm({ ...form, user_opinion: e.target.value })} />
        </FormField>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <FormField label="model">
            <input className="w-full rounded-xl border border-zinc-200 px-3 py-2" value={form.model} onChange={(e) => setForm({ ...form, model: e.target.value })} />
          </FormField>
          <FormField label="temperature">
            <input type="number" step="0.1" className="w-full rounded-xl border border-zinc-200 px-3 py-2" value={form.temperature} onChange={(e) => setForm({ ...form, temperature: e.target.value })} />
          </FormField>
        </div>
